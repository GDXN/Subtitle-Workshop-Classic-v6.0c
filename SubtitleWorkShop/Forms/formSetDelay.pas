...
type
  ...
  public
    { Public declarations }
    VideoTime, SubtitleTime: integer;
  end;
...
// added by Kameleon
procedure TfrmSetDelay.FormShow(Sender: TObject);
var Diff: longint;
begin
  Diff := VideoTime - SubtitleTime;
  if diff >= 0 then
  begin
    rdoDelayPlus.Checked := True;
  end else
  begin
    Diff := - Diff;
    rdoDelayMinus.Checked := True;
