...
type
  ...
  TfrmInfoErrors = class(TForm)
    ...
    procedure lstErrorsGetText(Sender: TBaseVirtualTree; Node: PVirtualNode; Column: TColumnIndex;
...
procedure TfrmInfoErrors.lstErrorsGetText(Sender: TBaseVirtualTree; Node: PVirtualNode; Column: TColumnIndex;
  TextType: TVSTTextType; var CellText: string);
(*
...
var
  ...
  Node : PVirtualNode;
begin
  if lstErrors.RootNodeCount = 0 then exit;   // Kameleon
...
begin
  ...
  try
    ...
    Width                               := Ini.ReadInteger('Information and Errors', 'Width', 695);  //Kameleon
    Height                              := Ini.ReadInteger('Information and Errors', 'Height', 853); // Kameleon
    ...
    lstErrors.Font.Size         := Ini.ReadInteger('List look', 'List Font',  11); // Kameleon
    lstErrors.DefaultNodeHeight := Ini.ReadInteger('List look', 'Row height', 18); // Kameleon
  finally
    Ini.Free;
  end;
