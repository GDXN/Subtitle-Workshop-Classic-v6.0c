...
type
  TfrmDivideLines = class(TForm)
    ...
    procedure tmeDuration1TimeChangeFromEditOnly(Sender: TObject;
      NewTime: Cardinal);
    procedure udDivideAfterBreakNumChangingEx(Sender: TObject; var AllowChange: Boolean; NewValue: Integer;
      Direction: TUpDownDirection);
  private
...
procedure TfrmDivideLines.udDivideAfterBreakNumChangingEx(Sender: TObject; var AllowChange: Boolean; NewValue: Integer;
  Direction: TUpDownDirection);
(*
