...
uses
  Windows, Messages, SysUtils, Classes, Graphics, Controls, Forms, Dialogs, StdCtrls, ExtCtrls, IniFiles, System.UITypes;
...
begin
  ...
  if frmMain.dlgLoadFile.FileName > '' then  // Kameleon
  dlgSave.InitialDir := ExtractFilePath(frmMain.dlgLoadFile.FileName); // Kameleon
  if (dlgSave.Execute) and (dlgSave.FileName <> '') then
  begin
