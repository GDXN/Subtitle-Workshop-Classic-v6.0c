...
function StringToWideStringEx(const S: string; CodePage: Word): String;
{$else}
function StringToWideStringEx(const S: string; CodePage: Word): String;
{$ifend}
function WideStringToStringEx(const WS: String; CodePage: Word): String;
// ------------------------------------------------//
...
//var
  ...
  //OutputLength: Integer;
begin
{$If CompilerVersion>= 22}  // Kameleon
  Result := WS;
{$else}
