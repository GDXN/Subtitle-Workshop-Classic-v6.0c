...
begin
  ...
  // Kameleon moved to here to prevent error as described by Adenry
  if Key = 13 then  // CR
  begin
    Key := 0; //IMPORTANT!
  ...
  if Key = 27 then  //ESCAPE - Cancel editing
    begin
      Key := 0; //IMPORTANT!
      FTree.CancelEditNode;
      FTree.SetFocus;
    end;
  // end Kameleon moved to here
end;
//added by adenry: end
...
{
  case Key of
   // Kameleon: move to KeyUp to prevent error as described by Adenry
