...
uses
  ...
  VirtualTrees,  FastStrings,  USubtitleAPI, _CommonTypes, formvariousInfo;
...
const
  ...
  ID_VERSION      = '6.0c/22';
  ID_BUILD        = '131122'; // version 6.0b was version 131121
  ...
  VideoExtsGroups: array [1..23] of array[1..2] of String = (
    ...
    ('MPEG-4', 'mp4'),
    ('MPEG-4 with DRM Copy Protection', 'm4v'), // Kameleon
    ('MTV','mtv'),
...
// ---------------
function SaveFile(FileName: String; FormatIndex: Integer; FPS: Single): Boolean;
...
procedure SetUTF8File(value: longbool);
  ...
  begin
    ...
    try
      ...
      begin
        ...
        lblTranslationLines.Enabled := false; //Kameleon
        lblLines2.Enabled           := false; //Kameleon
...
procedure SetUTF8File(value: longbool); // added by Kameleon
begin
  SubTitleAPI.Set_UTF8_File(value);
end;
