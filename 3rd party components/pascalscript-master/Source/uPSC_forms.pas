...
procedure SIRegister_Forms_TypesAndConsts(Cl: TPSPascalCompiler);
begin
  //Cl.AddTypeS('TIdleEvent', 'procedure (Sender: TObject; var Done: Boolean)');    // Kameleon
  ...
  //cl.AddTypeS('TCloseEvent' ,'procedure(Sender: TObject; var Action: TCloseAction)'); // Kameleon
  //cl.AddTypeS('TCloseQueryEvent' ,'procedure(Sender: TObject; var CanClose: Boolean)'); // Kameleon
